library("plotrix")
pdf('mping.allele_frq.ALL.pdf')
t <- read.table("RILs_ALL_fastq_correct_merged_duplicate_RelocaTEi.CombinedGFF.characterized.clean.mPing.frequency")
f <- t[,6]/272
#f <- f[f>0.005]
...
axis(2,c(0,100,200,300,400),line=0,labels=c(0,100,200,16300,16400))
