...
def main():
    ...
    print >> ofile, 'Sample\tShared_HEG4\tShared_RILs\tShared\tUnique\tUnique_hom\tUnique_het\tUnique_som\tPing_Number\tPing_Code\tRef_mPing\tNB_only\tShared_NB_HEG4\tOthers\tExcision'
