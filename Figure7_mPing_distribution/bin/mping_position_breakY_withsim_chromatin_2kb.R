...
pdf("mping_position_breakY_withsim_chromatin_2kb.pdf")
library("plotrix")
par(mar=c(6,4,4,2), cex=1.2)

ril5 <- read.table("../../Figure7_mPing_distribution_pre/bin/RIL.position_2kb.distr")
sim_both5 <- read.table("../../Figure7_mPing_distribution_pre/bin/results_simulationV2_Chromatin0.99_TSD9mer_ril/Simulate.TSD9mer.rilMat.position_2kb.distr")
sim_dhs5 <- read.table("../../Figure7_mPing_distribution_pre/bin/results_simulationV2_Chromatin0.99_ril/Simulate.TSD9mer.rilMat.position_2kb.distr")
sim_tsd5 <- read.table("../../Figure7_mPing_distribution_pre/bin/results_simulationV2_TSD9mer_ril/Simulate.TSD9mer.rilMat.position_2kb.distr")
control5 <- read.table("../../Figure7_mPing_distribution_pre/bin/results_simulationV2_Random_TSD9mer_ril/Simulate.TSD9mer.rilMat.position_2kb.distr")
