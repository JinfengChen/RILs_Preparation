pdf("Fig1c_unique_mping_hist_1.pdf")
...
breaks <- seq(0, 140, by = 1)
hist(mping$Unique_hom, breaks=breaks, right=FALSE, xlab="", ylab="Number of RILs", col="cornflowerblue", main="", cex.axis=1.4, cex.lab=1.4, border = 'gray29')
xpos=40
