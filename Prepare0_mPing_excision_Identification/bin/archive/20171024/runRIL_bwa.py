...
def main():
    ...
    for fq1 in sorted(fqs):
        ...
        ril = fq1_dirs[-2]
        cmd = 'perl /rhome/cjinfeng/BigData/00.RD/RILs/Transpostion/bin/Manuscript_Preparation/Prepare0_mPing_excision_Identification/bin/step1_Mapping.pl -ref %s -1 %s -2 %s -min 0 --max 500 -cpu 12 --tool bwa --project %s' %(args.ref, fq1, fq2, os.path.abspath(ril))
        print >> ofile, cmd
    ofile.close()
